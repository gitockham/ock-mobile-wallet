...
// import { OckNetwork, OckFees } from 'ock-ts/model';
// import { MlcPublicKey } from 'mlc-ts/core';
// import { MlcNetwork, MlcFees } from 'mlc-ts/model';
...
// import { OckTransactionSend, OckTransactionType } from 'ock-ts';
// import { MlcTransactionSend, MlcTransactionType } from 'mlc-ts';
...
/* export class OckTransactionSendPage implements OnInit {
  @ViewChild('sendTransactionForm') sendTransactionHTMLForm: HTMLFormElement;
  @ViewChild('pinCode') pinCode: PinCodeComponent;
  @ViewChild('confirmTransaction') confirmTransaction: ConfirmTransactionComponent;
  @ViewChild('qrScanner') qrScanner: QRScannerComponent;
  ...
  hasSent = false;
  sendAllEnabled = false;
  transactionType = OckTransactionType.SendOck;
...
/* export class MlcTransactionSendPage implements OnInit {
  @ViewChild('sendTransactionForm') sendTransactionHTMLForm: HTMLFormElement;
  @ViewChild('pinCode') pinCode: PinCodeComponent;
  @ViewChild('confirmTransaction') confirmTransaction: ConfirmTransactionComponent;
  @ViewChild('qrScanner') qrScanner: QRScannerComponent;
  ...
  hasSent = false;
  sendAllEnabled = false;
  transactionType = MlcTransactionType.SendMlc;
