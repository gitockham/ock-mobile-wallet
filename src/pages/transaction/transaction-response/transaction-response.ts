...
// import { OckTransactionType, OckNetwork } from 'ock-ts';
// import { MlcTransactionType, MlcNetwork } from 'mlc-ts';
...
/* export class OckTransactionResponsePage {
  @ViewChild(Content) content: Content;
  ...
  verifySecondPassphrasHasEncrypted() {
    ...
    if (this.transaction.type === OckTransactionType.SecondSignature || (this.wallet.secondSignature && !this.wallet.cipherSecondKey)) {
      if (this.response.status) { return this.showKeepSecondPassphrase = true; }
    }
...
/* export class MlcTransactionResponsePage {
  @ViewChild(Content) content: Content;
  ...
  verifySecondPassphrasHasEncrypted() {
    ...
    if (this.transaction.type === MlcTransactionType.SecondSignature || (this.wallet.secondSignature && !this.wallet.cipherSecondKey)) {
      if (this.response.status) { return this.showKeepSecondPassphrase = true; }
    }
