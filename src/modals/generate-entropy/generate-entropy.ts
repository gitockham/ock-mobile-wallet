...
// import { OckCrypto } from 'ock-ts/utils';
// import { MlcCrypto } from 'mlc-ts/utils';
...
/* export class OckGenerateEntropyModal {
  ...
  panEvent(e) {
    ...
    this.entropy[pos] = OckCrypto.randomSeed(1)[0];
...
/* export class MlcGenerateEntropyModal {
  ...
  panEvent(e) {
    ...
    this.entropy[pos] = MlcCrypto.randomSeed(1)[0];
