...
// import { OckNetwork, OckNetworkType } from 'ock-ts/model';
// import { MlcNetwork, MlcNetworkType } from 'mlc-ts/model';
...
/* export class OckUserDataProvider {
  ...
  public get isDevNet(): boolean {
    return this.currentNetwork && this.currentNetwork.type === OckNetworkType.Devnet;
  }

  public get isMainNet(): boolean {
    return this.currentNetwork && this.currentNetwork.type === OckNetworkType.Mainnet;
  }

  private _defaultNetworks: OckNetwork[];

  public get defaultNetworks(): OckNetwork[] {
    if (!this._defaultNetworks) {
      this._defaultNetworks = OckNetwork.getAll();
    }
    return this._defaultNetworks;
  }
  ...
  addOrUpdateNetwork(network: OckNetwork, networkId?: string): Observable<{ network: OckNetwork, id: string }> {
    if (!networkId) {
      networkId = this.generateUniqueId();
    }
  ...
  ensureWalletDelegateProperties(wallet: Wallet, delegateOrUserName: string | OckDelegate): void {
    if (!wallet) {
      return;
    }
...
/* export class MlcUserDataProvider {
  ...
  public get isDevNet(): boolean {
    return this.currentNetwork && this.currentNetwork.type === MlcNetworkType.Devnet;
  }

  public get isMainNet(): boolean {
    return this.currentNetwork && this.currentNetwork.type === MlcNetworkType.Mainnet;
  }

  private _defaultNetworks: MlcNetwork[];

  public get defaultNetworks(): MlcNetwork[] {
    if (!this._defaultNetworks) {
      this._defaultNetworks = MlcNetwork.getAll();
    }
    return this._defaultNetworks;
  }
  ...
  addOrUpdateNetwork(network: MlcNetwork, networkId?: string): Observable<{ network: MlcNetwork, id: string }> {
    if (!networkId) {
      networkId = this.generateUniqueId();
    }
  ...
  ensureWalletDelegateProperties(wallet: Wallet, delegateOrUserName: string | MlcDelegate): void {
    if (!wallet) {
      return;
    }
