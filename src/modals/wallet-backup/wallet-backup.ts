...
// import { OckPrivateKey } from 'ock-ts/core';
// import { MlcPrivateKey } from 'mlc-ts/core';
...
/* export class OckWalletBackupModal {
  ...
  private generateAccountFromEntropy() {
    ...
    const pvKey = OckPrivateKey.fromSeed(account.mnemonic, this.currentNetwork);
    const pbKey = pvKey.getPublicKey();
...
/* export class MlcWalletBackupModal {
  ...
  private generateAccountFromEntropy() {
    ...
    const pvKey = MlcPrivateKey.fromSeed(account.mnemonic, this.currentNetwork);
    const pbKey = pvKey.getPublicKey();
